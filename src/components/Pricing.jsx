...
export const PriceCard = ({ title, speed, price }) => (
  <div className="flex flex-col border w-full border-gray-200 text-left rounded-xl shadow-sm dark:border-gray-700">
    ...
    <ul className="mt-7 px-8 space-y-2.5 pb-10 text-sm">
      <li className="flex space-x-2">
        <svg className="flex-shrink-0 h-5 w-5 text-primary" width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <span className="text-gray-800 font-poppins dark:text-gray-400">
          Fast web browsing
        </span>
      </li>
    ...
    <div className=' px-8 flex flex-row items-center justify-center pb-6'>
      ...
      <p className='font-poppins font-normal text-md'>/Monthly</p>
    </div>
  </div>
