...
const CTA = () =>  (
  <section className={`${styles.flexCenter} ${styles.marginY} ${styles.padding} sm:flex-row flex-col lg:mx-0 bg-primary md:rounded-none box-shadow`}>
    <div className='flex-1 flex flex-col'>
      <h2 className={`md:text-left ${styles.heading2}`}>Ready to get started?</h2>
      <p className={`font-poppins font-normal md:text-left text-white text-[16px] leading-[30.8px] max-w-[470px] mb-5 mt-5`}>If you have any queries or enquiries you would like to enquire about
